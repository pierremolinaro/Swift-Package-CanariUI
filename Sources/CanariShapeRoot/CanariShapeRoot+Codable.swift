...
extension CanariShapeRoot : Codable {
  ...
  nonisolated public init (from inDecoder : Decoder) throws {
    ...
    for (shapeType, features) in SHAPE_TYPES_DESCRIPTION.shapeTypeArray {
      dictionary [features.typeNameInDocument] = shapeType
    }
    ...
    if let type = dictionary [typeName] {
      ...
      self.mDecoration = shape as! any CanariShapeDecorationProtocol <ANCHOR, DOCUMENT_SHAPES_DISPLAY_SETTINGS, SHAPE_TYPES_DESCRIPTION>
